...
def guessTheNumber():
	...
	num_input = input("Enter your choice of number between 1 to 10: ")
	if num_input.isdigit():
		num = int(num_input)
		if num < 1 or num > 10:
			return "Invalid Choice! Please choose a number between 1 to 10."
		else:
			if num == magic_num:
		...
		return "Please enter a valid integer between 1 to 10."
